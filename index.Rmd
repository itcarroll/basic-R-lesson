...
Good for statistics. simple syntax for regression, handles NAs well, data frames contain multiple types of data
...
Assign a value to an object with the syntax `objectName <- value`. 
